...
random_number = random.randint(1, 100) # fix this
print(f"Random number between 1 and 100: {random_number}")

# 5. Sample 5 numbers uniques from numbers list and print them out.
random_samples = random.sample(numbers, 5) # fix this
...
user_guess = int(input("Dime un número entre 1 y 10: ")) # fix this, hint: use int(input("..."))
random_number = random.randint(1, 10) # fix this, random number from 1 to 10
